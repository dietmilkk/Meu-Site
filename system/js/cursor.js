...
(function () {
  ...
  if (!("ontouchstart" in window)) {
    (function () {
      ...
      el.id = "retroCursor";
      el.innerHTML =
        '<img src="system/assets/cursors/Normal%20Select.cur" class="rc-img"><img src="system/assets/cursors/Link%20Select.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Text%20Select.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Move.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Vertical%20Resize.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Horizontal%20Resize.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Diagonal%20Resize%201.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Diagonal%20Resize%202.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Busy.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Working%20in%20Background.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Unavailable.cur" class="rc-img" style="display:none"><img src="system/assets/cursors/Help%20Select.cur" class="rc-img" style="display:none">';
