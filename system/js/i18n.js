(function(global) {
  ...
  var strings = {
    pt: {
      ...
      'desktop.games': 'Jogos',
      'desktop.soundcloud': 'Music Player',
      'desktop.club': '+ midia',
      ...
      'settings.eqWaveLabel': 'ESPECTRO',
      'settings.eqWaveOriginal': 'ORIGINAL',
      'settings.eqWaveSimulated': 'SIMULADO',
      ...
      'soundcloud.artworkTitle': 'Artwork',
      ...
      'soundcloud.defaultArtist': 'Music Player',
      'soundcloud.trackPrefix': 'Faixa ',
      'soundcloud.playlistPrefix': 'Playlist ',

      /* Club (Patreon-style content with Hotmart) */
      'club.title': '+ midia',
      'club.gateTitle': 'Conteúdo Exclusivo do Clube',
      'club.gateDesc': 'Este é um espaço de conteúdo profundo, bastidores, arquivos exclusivos e conversas que não cabem nas redes sociais. O acesso é restrito a membros do clube.',
      'club.gateBenefits': 'O que você ganha ao entrar:',
      'club.benefit1': 'Posts semanais exclusivos (textos, áudios, imagens, vídeos)',
      'club.benefit2': 'Conteúdo antecipado (48h antes do público)',
      'club.benefit3': 'Acesso ao Discord privado da comunidade',
      'club.benefit4': 'Enquetes para decidir próximos temas e projetos',
      'club.benefit5': 'Downloads de wallpapers, ícones e assets em alta resolução',
      'club.benefit6': 'Lives mensais exclusivas + chamadas trimestrais (Fundadores)',
      'club.gateBtn': '🔓  Escolher plano e assinar via Hotmart',
      'club.gateNote': 'O pagamento é processado com segurança pela Hotmart. Após a confirmação, seu acesso é liberado instantaneamente. Pode cancelar quando quiser.',
     'club.navPosts': '🖼 Posts',
     'club.navTiers': '💎 Meu Plano',
     'club.navProfile': '👤 Perfil',
     'club.navMessages': '✉ Mensagens',
     'club.profileTitle': 'Meu Perfil',
     'club.profileName': 'Nome de exibição',
     'club.profilePhoto': 'Foto de perfil',
     'club.profileUpload': '📁 Enviar foto',
     'club.profileReset': '↺ Padrão',
     'club.profilePresets': 'Ou escolha uma cor:',
     'club.profileSave': '💾 Salvar perfil',
     'club.messagesTitle': 'Mensagens para o criador',
     'club.messagesPlaceholder': 'Escreva sua mensagem para o criador...',
     'club.messagesSend': '➤ Enviar',
     'club.logout': 'Sair',
    ...
    en: {
      ...
      'settings.eqWaveLabel': 'SPECTRUM',
      'settings.eqWaveOriginal': 'ORIGINAL',
      'settings.eqWaveSimulated': 'SIMULATED',
      ...
      /* Club (Patreon-style content with Hotmart) */
      'club.title': '+ midia',
      'club.gateTitle': 'Exclusive Club Content',
      'club.gateDesc': 'This is a space for deep content, behind-the-scenes, exclusive files, and conversations that don\'t fit on regular social media. Access is restricted to club members.',
      'club.gateBenefits': 'What you get by joining:',
      'club.benefit1': 'Weekly exclusive posts (text, audio, images, videos)',
      'club.benefit2': 'Early access content (48h before public)',
      'club.benefit3': 'Access to private community Discord',
      'club.benefit4': 'Polls to decide future topics and projects',
      'club.benefit5': 'High-res downloads of wallpapers, icons, and assets',
      'club.benefit6': 'Monthly exclusive lives + quarterly calls (Founders)',
      'club.gateBtn': '🔓  Choose plan & subscribe via Hotmart',
      'club.gateNote': 'Payment is securely processed by Hotmart. After confirmation, your access is instantly unlocked. Cancel anytime.',
      'club.navPosts': '🖼 Posts',
      'club.navTiers': '💎 My Plan',
      'club.navProfile': '👤 Profile',
      'club.navMessages': '✉ Messages',
      'club.profileTitle': 'My Profile',
      'club.profileName': 'Display name',
      'club.profilePhoto': 'Profile photo',
      'club.profileUpload': '📁 Upload photo',
      'club.profileReset': '↺ Default',
      'club.profilePresets': 'Or pick a color:',
      'club.profileSave': '💾 Save profile',
      'club.messagesTitle': 'Messages to the creator',
      'club.messagesPlaceholder': 'Write your message to the creator...',
      'club.messagesSend': '➤ Send',
      'club.logout': 'Logout',
    ...
    zh: {
      ...
      'settings.eqWaveLabel': '频谱',
      'settings.eqWaveOriginal': '原声',
      'settings.eqWaveSimulated': '模拟',
      'settings.apply': '应用',
      ...
      /* SoundCloud */
      'soundcloud.title': '音乐播放器',
      'soundcloud.playlistTitle': '播放列表',
      'soundcloud.artworkTitle': '封面',
      ...
      'soundcloud.defaultArtist': '音乐播放器',
      'soundcloud.trackPrefix': '曲目 ',
      'soundcloud.playlistPrefix': '播放列表 ',

      /* Club (Patreon-style content with Hotmart) */
      'club.title': '+ midia',
      'club.gateTitle': '俱乐部独家内容',
      'club.gateDesc': '这是一个深度内容、幕后花絮、独家文件和对话的空间，这些内容不适合发在常规社交媒体上。仅限俱乐部成员访问。',
      'club.gateBenefits': '加入后你将获得：',
      'club.benefit1': '每周独家帖子（文字、音频、图片、视频）',
      'club.benefit2': '抢先体验内容（比公开早 48 小时）',
      'club.benefit3': '访问私有 Discord 社区',
      'club.benefit4': '投票决定未来主题和项目',
      'club.benefit5': '高清壁纸、图标和素材下载',
      'club.benefit6': '每月独家直播 + 季度通话（创始人）',
      'club.gateBtn': '🔓  选择方案并通过 Hotmart 订阅',
      'club.gateNote': '支付由 Hotmart 安全处理。确认后即时解锁访问权限。随时可取消。',
      'club.navPosts': '🖼 动态',
      'club.navTiers': '💎 我的方案',
      'club.navProfile': '👤 个人资料',
      'club.navMessages': '✉ 私信',
      'club.profileTitle': '我的个人资料',
      'club.profileName': '显示名称',
      'club.profilePhoto': '头像',
      'club.profileUpload': '📁 上传照片',
      'club.profileReset': '↺ 默认',
      'club.profilePresets': '或选择一种颜色：',
      'club.profileSave': '💾 保存资料',
      'club.messagesTitle': '给创作者的消息',
      'club.messagesPlaceholder': '给创作者留言...',
      'club.messagesSend': '➤ 发送',
      'club.logout': '退出',
